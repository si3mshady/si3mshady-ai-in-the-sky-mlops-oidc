...
CLASS_NAMES: List[str] = ["air_conditioner","car_horn","children_playing","dog_bark","drilling",
...
# --------- Preprocessing (MATCHES TRAINING: min–max over log-mel) ----------
def _to_window(y: np.ndarray, sr: int) -> np.ndarray:
    ...
    # MIN–MAX like training (not z-score)
